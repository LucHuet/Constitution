 ...
 */
final class Version20181005193104 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE acteur_partie (id INT AUTO_INCREMENT NOT NULL, partie_id INT NOT NULL, type_acteur_id INT NOT NULL, nom VARCHAR(255) NOT NULL, nombre_individus INT DEFAULT NULL, stabilite INT NOT NULL, equilibre INT NOT NULL, democratie INT NOT NULL, force_acteur INT NOT NULL, INDEX IDX_CF6D2253E075F7A4 (partie_id), INDEX IDX_CF6D22536EA9165A (type_acteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE condition_pouvoir_partie (id INT AUTO_INCREMENT NOT NULL, condition_pouvoir_id INT NOT NULL, partie_id INT NOT NULL, pouvoir_partie_id INT NOT NULL, nom VARCHAR(255) NOT NULL, parametre LONGTEXT DEFAULT NULL, stabilite INT NOT NULL, equilibre INT NOT NULL, democratie INT NOT NULL, INDEX IDX_B3255A7C3B7A385E (condition_pouvoir_id), INDEX IDX_B3255A7CE075F7A4 (partie_id), INDEX IDX_B3255A7C49D3C5A8 (pouvoir_partie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE designation_partie (id INT AUTO_INCREMENT NOT NULL, designation_id INT NOT NULL, acteur_designe_id INT NOT NULL, acteur_designant_id INT DEFAULT NULL, partie_id INT NOT NULL, nom VARCHAR(255) NOT NULL, stabilite INT NOT NULL, equilibre INT NOT NULL, democratie INT NOT NULL, INDEX IDX_24553869FAC7D83F (designation_id), INDEX IDX_245538697995E169 (acteur_designe_id), INDEX IDX_2455386951964AD6 (acteur_designant_id), INDEX IDX_24553869E075F7A4 (partie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE partie (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, nom VARCHAR(255) NOT NULL, stabilite INT NOT NULL, equilibre INT NOT NULL, democratie INT NOT NULL, INDEX IDX_59B1F3DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE acteur (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, stabilite INT NOT NULL, equilibre INT NOT NULL, democratie INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pouvoir (id INT AUTO_INCREMENT NOT NULL, pouvoir_parent_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, importance INT NOT NULL, stabilite INT NOT NULL, equilibre INT NOT NULL, democratie INT NOT NULL, groupe_pouvoir VARCHAR(255) DEFAULT NULL, INDEX IDX_BE7F6EC6DBDCF87C (pouvoir_parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE designation (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, stabilite INT NOT NULL, equilibre INT NOT NULL, democratie INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE condition_pouvoir (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, stabilite INT NOT NULL, equilibre INT NOT NULL, democratie INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
