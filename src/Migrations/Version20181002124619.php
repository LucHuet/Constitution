 ...
 */
final class Version20181002124619 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE condition_pouvoir_partie (id INT AUTO_INCREMENT NOT NULL, condition_pouvoir_id INT NOT NULL, partie_id INT NOT NULL, nom VARCHAR(255) NOT NULL, parametre LONGTEXT DEFAULT NULL, INDEX IDX_B3255A7C3B7A385E (condition_pouvoir_id), INDEX IDX_B3255A7CE075F7A4 (partie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE designation_partie (id INT AUTO_INCREMENT NOT NULL, designation_id INT NOT NULL, acteur_designe_id INT NOT NULL, acteur_designant_id INT NOT NULL, partie_id INT NOT NULL, nom VARCHAR(255) NOT NULL, INDEX IDX_24553869FAC7D83F (designation_id), INDEX IDX_245538697995E169 (acteur_designe_id), INDEX IDX_2455386951964AD6 (acteur_designant_id), INDEX IDX_24553869E075F7A4 (partie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
