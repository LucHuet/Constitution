 ...
 */
final class Version20180915093258 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE designation_partie (id INT AUTO_INCREMENT NOT NULL, designation_id INT NOT NULL, acteur_destinataire_id INT NOT NULL, acteur_recepteur_id INT NOT NULL, condition_designation_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, INDEX IDX_24553869FAC7D83F (designation_id), INDEX IDX_24553869994C61C5 (acteur_destinataire_id), INDEX IDX_245538696F3330DD (acteur_recepteur_id), UNIQUE INDEX UNIQ_24553869AE56F0D1 (condition_designation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
