 ...
 */
final class Version20181207160732 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pouvoir (id INT AUTO_INCREMENT NOT NULL, pouvoir_parent_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, groupe_pouvoir VARCHAR(255) DEFAULT NULL, INDEX IDX_BE7F6EC6DBDCF87C (pouvoir_parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
