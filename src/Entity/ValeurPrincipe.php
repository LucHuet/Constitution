...
/**
 * @ORM\Entity(repositoryClass="App\Repository\ValeurPrincipeRepository")
 */
class ValeurPrincipe
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Partie", inversedBy="valeurPrincipes")
     */
    private $partie;
